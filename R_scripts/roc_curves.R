...
data <- read.table('../results/logs/validation_2-1_new_oversampling.txt', sep = '\t', header = TRUE)


ggplot(mapping = aes(x = FP/(FP+TN)*100, y = Rec, color = Fold))+   # change color to Fold to match lines with folds
